        ...
        <div>
            <div className='mainWrapper'>
                <div className='mainIntroWrapper'>
                    <h1 className="greet">WELCOME TO TASKLIST PLATFORM HYM <img src="/media/greeting.png" alt="" width={18} height={18} /></h1>
                    <div className='intro-wrapper'>
                        <div className="main-intro">
                            <img src="/media/mainPicture.jpg" alt="" />
                        ...
                        <div className='taskNums'>
                            <div>
                                ...
                                <div><img src="/media/checklist.png" alt="" width={60} height={60} /></div>
                            </div>
                            <div>
                                <div>
                                    <span>15</span>
                                ...
                                <div><img src="/media/list.png" alt="" width={58} height={58} /></div>
                            </div>
                            <div>
                                <div>
                                    <span>30</span>
                                ...
                                <div><img src="/media/clock.png" alt="" width={58} height={58} /></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="groupSec">
                    ...
                    <div className="cards">
                        <div className="card">
                            <img src="/media/groupPic1.jpg" alt="" />
                            <h2>Groups</h2>
