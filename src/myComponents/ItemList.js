        ...
        <div>
            <div className="itemListWrapper">
                <div className='listHeader'>
                    <div>
                        <h1>Hey Again, Here Your Tasks <img src="/media/greeting.png" alt="" width={18} height={18} /></h1>
                        <p>Today: {formattedDate}</p>
                    </div>
                    <div>
                        <div>
                            <div className="searchWrapper">
                                <img src="/media/search.png" alt="" width={15} height={15} />
                                <input type="text" value={search} onChange={handleSearch} />
                            </div>
                        </div>
                        <div>
                            <img src="/media/filter.png" alt="" width={22} height={22} onClick={() => filStateClick('filbtn')} />
                ...
                <div className='items'>
                    {filteredTasks.map(item => (
                        <div className={`item ${item.stateName === 'completed' ? 'finished' : ''}`} key={item.id}>
                            <div>
                                <img src={`/media/${listInfo[item.listName]}.png`} alt="" width={15} height={15} />
                                <p>{item.title}</p>
                                {item.tag.tagName === 'noTag' || <span id='tagItem' style={{ backgroundColor: tagList[item.tag.tagName] }} >#{item.tag.tagName}</span>}
                            </div>
                            <div>
                                <div id='membersGP'>
                                    <img src="/media/avatar.png" alt="" width={25} height={25} />
                                </div>
                                <p>{item.dueDate == null ? 'XX XX, XXXX' : format(item.dueDate, "eeee dd, yyyy")}</p>
                                <img src="/media/points.png" key={1} alt="" width={20} height={20} onClick={() => toggleOptions(item.id)} />
